...
begin
    ...
    SELECT to_char(SYSDATE, 'YYYYMMDDHH24MI')||'_Name_Details_TabTemps.log' INTO v_ficlog FROM dual ;

        v_code := SCHEMA1.PACKAGE_1GB.MAIN_PRINCIPAL(v_ficlog, v_date_trait);
